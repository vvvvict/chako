 ...
 */
	Configure::write('Security.salt', 'jasofjoiwnflsnvld;vncagvazYhG93b0qyJfIxfs2guFgaC9miD');
//	Configure::write('Security.salt', 'DYhG93b0qyJfIxfs2guVoUubWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '2890524835823568593096574535424967496836457');
